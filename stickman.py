	...
	def draw(self):
		...
		with self.canvas:
			...
			self.arm21 = CLine(points=[
			   (p[0], p[1]-h.size[1]*.2),
			   (p[0]+h.size[0]*.75, p[1]-h.size[1]*0.7)], width=width, source="/sdcard/pictures/12668.jpg")
			...
			self.leg22 = CLine(points=(self.leg21.points[-2:],(p[0]+h.size[0]*.9, p[1]-h.size[1]*4.7)), width=width)#self.legsrc[1][1])
